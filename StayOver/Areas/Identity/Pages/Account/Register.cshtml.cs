...
namespace StayOver.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(20, ErrorMessage = "Phone number doesn't seem to be valid.", MinimumLength = 9)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // If we got this far and something failed, redisplay form
            return Page();
        }
    }
}
